...
return e.replace(L,F)},e.htmlSafe=U,e.isHTMLSafe=B,e._resetRenderers=function(){Er.length=0},e.renderSettled=function(){null===Tr&&(Tr=A.default.defer(),(0,f._getCurrentRunLoop)()||f._backburner.schedule("actions",null,wr))
...
default:return g.clientBuilder.bind(null)}}}),e.injection("service:-dom-builder","bootOptions","-environment:main"),e.injection("renderer","builder","service:-dom-builder"),e.register(T.privatize`template:-root`,j),e.injection("renderer","rootTemplate",T.privatize`template:-root`),e.register("renderer:-dom",Pr),e.injection("renderer","document","service:-document")},e.setComponentManager=function(e,t){var r
...
a.EMBER_COMPONENT_IS_VISIBLE&&"style"===l&&void 0!==H&&(h=H(h,(0,o.childRefFor)(t,"isVisible"))),i.setAttribute(l,h,!1,null)}var H,q,Y="display: none;",G=U(Y)
...
class At{constructor(e){this.handle=-1,this.resolvedName="-top-level",this.capabilities=(0,d.capabilityFlagsFrom)(St),this.compilable=null,this.manager=new xt(e),this.state=(0,T.getFactoryFor)(e)}}class jt{constructor(e){this.inner=e}}var Mt=J((({positional:e})=>{var t=e[0]
...
return this.position++,this.result=e.next(),{value:n,memo:i}}}class Ut extends Ft{valueFor(e){return e.value}memoFor(e,t){return t}}class Bt extends Ft{valueFor(e){return e.value[1]}memoFor(e){return e.value[0]}}function zt(e){return"function"==typeof e.forEach}function Vt(e){return"function"==typeof e[Symbol.iterator]}(0,k.default)({scheduleRevalidate(){f._backburner.ensureInstance()},toBool:function(e){return(0,h.isProxy)(e)?((0,l.consumeTag)((0,n.tagForProperty)(e,"content")),Boolean((0,n.get)(e,"isTruthy"))):(0,b.isArray)(e)?((0,l.consumeTag)((0,n.tagForProperty)(e,"[]")),0!==e.length):(0,P.isHTMLSafe)(e)?Boolean(e.toString()):Boolean(e)},toIterator:function(e){return e instanceof jt?function(e){if(t=e,null===t||"object"!=typeof t&&"function"!=typeof t)return null
var t
...
class $t{constructor(e,t){this.owner=e,this.isInteractive=t,this.enableDebugTooling=w.ENV._DEBUG_RENDER_TREE}onTransactionCommit(){}}var Ht=J((({positional:e,named:t})=>{var r=e[0],n=t.type,i=t.loc,a=t.original;(0,o.valueForRef)(n),(0,o.valueForRef)(i),(0,o.valueForRef)(a)
return(0,o.createComputeRef)((()=>{var e=(0,o.valueForRef)(r)
return e}))})),qt=J((e=>e.positional[0])),Yt=J((({positional:e})=>(0,o.createComputeRef)((()=>{var t=(0,o.valueForRef)(e[0]).split("."),r=t[t.length-1],n=(0,o.valueForRef)(e[1])
...
return e}appendOutletView(e,r){var n=function(e){if(w.ENV._APPLICATION_TEMPLATE_WRAPPER){var r=(0,t.assign)({},Rt,{dynamicTag:!0,elementHook:!0,wrapped:!0}),n=new class extends Pt{getTagName(){return"div"}getCapabilities(){return r}didCreateElement(e,t){t.setAttribute("class","ember-view"),t.setAttribute("id",(0,h.guidFor)(e))}}
...
function jr(e){return null==e}function Mr(e){return!jr(e)}function Nr(e){return"object"==typeof e&&null!==e&&!0===e.isQueryParams}(0,i.debugFreeze)(Sr),(0,i.debugFreeze)(Ar)
...
var Kr=Be(Ir,Cr),Xr=wt((function(e){return s.loc.apply(null,e)})),Jr=(0,r.templateFactory)({id:"3jT+eJpe",block:'[[[46,[28,[37,1],null,null],null,null,null]],[],false,["component","-outlet"]]',moduleName:"packages/@ember/-internals/glimmer/lib/templates/outlet.hbs",isStrictMode:!1}),Zr="-top-level",en="main"
...
if(n)return n.valueFor(r)},e.alias=function(e){return oe(new Ie(e),Ne)},e.deprecateProperty=function(e,t,r,n){Object.defineProperty(e,t,{configurable:!0,enumerable:!1,set(e){Pe(this,r,e)},get(){return Oe(this,r)}})},e._getPath=Te,e.get=Oe,e.getWithDefault=function(e,t,r){var n=Oe(e,t)
if(void 0===n)return r
return n},e._getProp=we,e.set=Pe,e._setProp=ke,e.trySet=function(e,t,r){return Pe(e,t,r,!0)},e.objectAt=Y,e.replace=function(e,t,r,n=q){Array.isArray(e)?W(e,t,r,n):e.replace(t,r,n)},e.replaceInNativeArray=W,e.addArrayObserver=function(e,t,r,n=!1){return Q(e,t,r,v,!1)},e.removeArrayObserver=function(e,t,r,n=!1){return Q(e,t,r,g,!0)},e.arrayContentWillChange=$,e.arrayContentDidChange=H,e.eachProxyArrayWillChange=function(e,t,r,n){var i=Fe.get(e)
...
return V((()=>{for(var r,n=Object.keys(t),i=0;i<n.length;i++)r=n[i],Pe(e,r,t[r])})),t},e.expandProperties=fe,e.addObserver=w,e.activateObserver=P,e.removeObserver=T,e.flushAsyncObservers=function(e=!0){var r=(0,o.valueForTag)(o.CURRENT_TAG)
if(A===r)return
...
null!==o&&(o.isPrototypeMeta(e)||o.isInitializing())||x(e,s,a),g(e,s,n,i)}function R(e,t){var r=!0===t?E:O
return r.has(e)||(r.set(e,new Map),(0,s.registerDestructor)(e,(()=>function(e){E.size>0&&E.delete(e)
O.size>0&&O.delete(e)}(e)),!0)),r.get(e)}function P(e,r,n=!1){var i=R(e,n)
...
var k=!1,C=[]
function x(e,t,r=!1){if(!0!==k){var n=!0===r?E:O,i=n.get(e)
...
function j(){E.forEach(((e,r)=>{var n=(0,t.peekMeta)(r)
...
null!==a&&(a.isInitializing()||a.isPrototypeMeta(e))||(D(e,r),F<=0&&j(),L in e&&(4===arguments.length?e[L](r,i):e[L](r)))}function B(){F++,k=!0}function z(){--F<=0&&(j(),function(){for(var[e,t,r]of(k=!1,C))x(e,t,r)
C=[]}())}function V(e){B()
...
M(e,t,!0)
try{i=o.call(e,t,r,s)}finally{M(e,t,!1)}return a&&s===i||(n.setValueFor(t,i),U(e,t,n,r)),i}teardown(e,t,r){this._volatile||void 0!==r.revisionFor(t)&&(r.setRevisionFor(t,void 0),r.setValueFor(t,void 0)),super.teardown(e,t,r)}}e.ComputedProperty=Se
...
return 0===arguments.length?t._meta||{}:(t._meta=e,this)}get _getter(){return ce(this)._getter}set enumerable(e){ce(this).enumerable=e}}function Me(...e){return te(e)?oe(new Se([]),je)(e[0],e[1],e[2]):oe(new Se(e),je)}class Ne extends Function{readOnly(){return ce(this).readOnly(),this}oneWay(){return ce(this).oneWay(),this}meta(e){var t=ce(this)
...
E=w(E)
var O=g.type||(0,a.typeOf)(E),T=this.serializeQueryParam(E,_,O),R=`${r}:${v}`,P={undecoratedDefaultValue:(0,n.get)(o,v),defaultValue:E,serializedDefaultValue:T,serializedValue:T,type:O,urlKey:_,prop:v,scopedPropertyName:R,controllerName:r,route:this,parts:y,values:null,scope:b}
h[v]=h[_]=h[R]=P,d.push(P),m.push(v)}return{qps:d,map:h,propertyNames:m,states:{inactive:(e,t)=>{var r=h[e]
...
f=(0,n.assign)({},v,f)}o[p]=f}return o}if(b.isClass=!0,b.isMethod=!1,!i.HAS_NATIVE_SYMBOL){var _=new WeakMap,E=new WeakMap
...
if(!P.has(t)&&O(t))return k(e,k(t,E))
...
var n=T.get(e)
return void 0!==n&&T.set(r,n),r}var{toString:C}=Object.prototype,{toString:x}=Function.prototype,{isArray:S}=Array,{keys:A}=Object,{stringify:j}=JSON,M=100,N=/^[\w$]+$/
...
Object.defineProperties(String.prototype,{w:{configurable:!0,enumerable:!1,writeable:!0,value:j("w",T)},loc:{configurable:!0,enumerable:!1,writeable:!0,value(...e){return w(this,e)}},camelize:{configurable:!0,enumerable:!1,writeable:!0,value:j("camelize",k)},decamelize:{configurable:!0,enumerable:!1,writeable:!0,value:j("decamelize",R)},dasherize:{configurable:!0,enumerable:!1,writeable:!0,value:j("dasherize",P)},underscore:{configurable:!0,enumerable:!1,writeable:!0,value:j("underscore",x)},classify:{configurable:!0,enumerable:!1,writeable:!0,value:j("classify",C)},capitalize:{configurable:!0,enumerable:!1,writeable:!0,value:j("capitalize",S)}})}})),e("@ember/string/lib/string_registry",["exports"],(function(e){"use strict"
...
var r=d(s,e)
if(void 0===r&&!0===t)return null
return r},e.hasInternalHelperManager=function(e){return void 0!==d(l,e)},e.hasInternalModifierManager=function(e){return void 0!==d(o,e)},e.hasInternalComponentManager=function(e){return void 0!==d(s,e)},e.setHelperManager=function(e,t){return p(new M(e),t)},e.setModifierManager=function(e,t){return h(new x(e),t)},e.setComponentManager=function(e,t){return f(new k(e),t)},e.componentCapabilities=function(e,t={}){0
var r=!0
...
return null!==r&&r<this.positional.length}}v=t.HAS_NATIVE_PROXY?(e,t)=>{var{named:r,positional:n}=e,i=new O(r),a=new w(n),s=Object.create(null),o=new Proxy(s,i),l=new Proxy([],a)
...
return{named:i,positional:n.map(r.valueForRef)}}function A(e){return e.capabilities.hasValue}function j(e){return e.capabilities.hasDestroyable}e.CustomModifierManager=x
...
"number"==typeof n&&(n=(0,t.isSmallInt)(n)?(0,t.encodeImmediate)(n):{type:6,value:n}),e(30,n)}function S(e,t,n,i){e(0),T(e,n,i,!1),e(16,t),e(1),e(36,r.$v0)}function A(e,t,n,i){e(0),T(e,t,n,!1),e(33,r.$fp,1),e(107),i?(e(36,r.$v0),i(),e(1),e(34,1)):(e(1),e(34,1),e(36,r.$v0))}function j(e,t,r){T(e,r,null,!0),e(23,t),e(24),e(61),e(64),e(40),e(1)}function M(e,t){(function(e,t){null!==t?e(63,d({parameters:t})):x(e,null)})(e,t&&t[1]),e(62),D(e,t)}function N(e,t){e(0),D(e,t),e(61),e(2),e(1)}function I(e,t,n){var i=t[1],a=i.length,s=Math.min(n,a)
...
e(1e3,o.label),e(34,1),o.callback(),0!==s&&e(4,u("END"))}e(1e3,"END"),e(1002),e(70)}function F(e,t,r){e(1001),e(0),e(6,u("ENDINITIAL")),e(69,t()),r(),e(1e3,"FINALLY"),e(70),e(5),e(1e3,"ENDINITIAL"),e(1),e(1002)}function U(e,t,r,n){return F(e,t,(()=>{e(66,u("ELSE")),r(),e(4,u("FINALLY")),e(1e3,"ELSE"),void 0!==n&&n()}))}E.add(29,((e,[,t])=>{for(var r of t)w(e,r)
e(27,t.length)})),E.add(28,((e,[,t,r,n])=>{v(t)?e(1005,t,(t=>{S(e,t,r,n)})):(w(e,t),A(e,r,n))})),E.add(50,((e,[,t,n,i,a])=>{(function(e,t,n,i,a){e(0),T(e,i,a,!1),e(86),w(e,n),e(77,t,{type:2,value:void 0}),e(1),e(36,r.$v0)})(e,n,t,i,a)})),E.add(30,((e,[,t,r])=>{e(21,t),O(e,r)})),E.add(32,((e,[,t,r])=>{e(1011,t,(t=>{e(29,t),O(e,r)}))})),E.add(31,((e,[,t,r])=>{e(1009,t,(e=>{}))})),E.add(33,((e,[,t,r])=>{e(1010,t,((t,r)=>{e(21,0),e(22,t)})),O(e,r)})),E.add(34,(()=>{throw new Error("unimplemented opcode")})),E.add(36,((e,t)=>{e(1010,t[1],(r=>{e(1006,t,{ifHelper:t=>{S(e,t,null,null)},ifFallback:(t,r)=>{e(21,0),e(22,t)}})}))})),E.add(99,((e,t)=>{e(1010,t[1],(r=>{e(1006,t,{ifHelper:(r,n,i)=>{t[2][0]
...
if(null!==l){O=l[0]
for(var T=l[1],P=0;P<T.length;P++){var k=d.indexOf(O[P])
w(e,T[P]),f.push(k)}}e(82,O,t.EMPTY_STRING_ARRAY,E),f.push(-1)}else if(null!==l)for(var C=l[0],x=l[1],S=0;S<x.length;S++){var A=C[S],j=d.indexOf(A);-1!==j&&(w(e,x[S]),f.push(j),m.push(A))}e(97,r.$s0),(0,i.hasCapability)(n,64)&&e(59);(0,i.hasCapability)(n,512)&&e(87,0|u.has("default"),r.$s0)
...
function K(e){return"string"==typeof e?e:Q[e]}function X(e){return"string"==typeof e?e:W[e]}function J(e){return null===e?null:[e[0].map((e=>`@${e}`)),e[1]]}G.add(3,((e,t)=>e(42,t[1]))),G.add(13,(e=>e(55))),G.add(12,(e=>e(54))),G.add(4,((e,[,t,n,i])=>{m(t)?e(1003,t,(t=>{e(0),T(e,n,i,!1),e(57,t),e(1)})):(w(e,t),e(0),T(e,n,i,!1),e(33,r.$fp,1),e(108),e(1))})),G.add(14,((e,[,t,r,n])=>{e(51,X(t),r,null!=n?n:null)})),G.add(24,((e,[,t,r,n])=>{e(105,X(t),r,null!=n?n:null)})),G.add(15,((e,[,t,r,n])=>{w(e,r),e(52,X(t),!1,null!=n?n:null)})),G.add(22,((e,[,t,r,n])=>{w(e,r),e(52,X(t),!0,null!=n?n:null)})),G.add(16,((e,[,t,r,n])=>{w(e,r),e(53,X(t),!1,null!=n?n:null)})),G.add(23,((e,[,t,r,n])=>{w(e,r),e(53,X(t),!0,null!=n?n:null)})),G.add(10,((e,[,t])=>{e(48,K(t))})),G.add(11,((e,[,t])=>{e(89),e(48,K(t))})),G.add(8,((e,[,t,r,n,i])=>{f(t)?e(1004,t,(t=>{z(e,t,r,null,n,i)})):V(e,t,r,null,n,i,!0,!0)})),G.add(19,((e,[,t,n])=>{U(e,(()=>(w(e,t),e(33,r.$sp,0),2)),(()=>{e(101,{type:3,value:void 0},n),e(40),e(1)}))})),G.add(18,((e,[,t,r])=>j(e,t,r))),G.add(17,((e,[,t])=>j(e,t,null))),G.add(26,((e,[,t])=>e(103,{type:3,value:void 0},t))),G.add(1,((e,[,t])=>{if(Array.isArray(t))if(b(t))e(1008,t,{ifComponent(t){z(e,t,null,null,null,null)},ifHelper(t){e(0),S(e,t,null,null),e(3,c("cautious-non-dynamic-append")),e(1)},ifValue(t){e(0),e(29,t),e(3,c("cautious-non-dynamic-append")),e(1)},ifFallback(r){e(0),e(1010,t[1],((t,r)=>{e(21,0),e(22,t)})),e(3,c("cautious-append")),e(1)}})
else if(28===t[0]){var[,r,n,i]=t
g(r)?e(1007,r,{ifComponent(t){z(e,t,null,n,J(i),null)},ifHelper(t){e(0),S(e,t,n,i),e(3,c("cautious-non-dynamic-append")),e(1)}}):L(e,(()=>{w(e,r),e(106)}),(t=>{t(0,(()=>{e(81),e(79),$(e,{capabilities:!0,elementBlock:null,positional:n,named:i,atNames:!1,blocks:l(null)})})),t(1,(()=>{A(e,n,i,(()=>{e(3,c("cautious-non-dynamic-append"))}))}))}))}else e(0),w(e,t),e(3,c("cautious-append")),e(1)
else e(41,null==t?"":String(t))})),G.add(2,((e,[,t])=>{Array.isArray(t)?(e(0),w(e,t),e(3,c("trusting-append")),e(1)):e(41,null==t?"":String(t))})),G.add(6,((e,[,t,r,n,i])=>{f(t)?e(1004,t,(t=>{z(e,t,null,r,J(n),i)})):V(e,t,null,r,n,i,!1,!1)})),G.add(40,((e,[,t,n,i,a])=>{U(e,(()=>(w(e,n),void 0===a?C(e,void 0):w(e,a),w(e,i),e(33,r.$sp,0),4)),(()=>{e(50),N(e,t),e(56)}))})),G.add(41,((e,[,t,r,n])=>U(e,(()=>(w(e,t),e(71),1)),(()=>{N(e,r)}),n?()=>{N(e,n)}:void 0))),G.add(42,((e,[,t,n,i,a])=>F(e,(()=>(n?w(e,n):C(e,null),w(e,t),2)),(()=>{e(72,u("BODY"),u("ELSE")),e(0),e(33,r.$fp,1),e(6,u("ITER")),e(1e3,"ITER"),e(74,u("BREAK")),e(1e3,"BODY"),I(e,i,2),e(34,2),e(4,u("FINALLY")),e(1e3,"BREAK"),e(1),e(73),e(4,u("FINALLY")),e(1e3,"ELSE"),a&&N(e,a)})))),G.add(43,((e,[,t,n,i])=>{U(e,(()=>(w(e,t),e(33,r.$sp,0),e(71),2)),(()=>{I(e,n,1)}),(()=>{i&&N(e,i)}))})),G.add(44,((e,[,t,r])=>{I(e,r,R(e,t))})),G.add(45,((e,[,t,r])=>{if(t){var[n,i]=t
R(e,i),function(e,t,r){e(59),e(58,t),r(),e(60)}(e,n,(()=>{N(e,r)}))}else N(e,r)})),G.add(46,((e,[,t,r,n,i])=>{f(t)?e(1004,t,(t=>{z(e,t,null,r,J(n),i)})):V(e,t,null,r,n,i,!1,!1)}))
...
var i=R(r)
if(B(n,t)){var a=j(i)
if(U(N,a))return`unsafe:${i}`}return z(n,t)?`unsafe:${i}`:i}function Y(e,t,r,n=!1){var{tagName:i,namespaceURI:a}=e,s={element:e,name:t,namespace:r}
...
function be(e){return ge.has(e)}function ye(e,t){return be(e)&&e[he]===t}class _e{constructor(e,t,r,n,i=!1){ge.add(this),this[he]=e,this[pe]=t,this[fe]=r,this[me]=n,this[ve]=i}}function Ee(e){for(var t,r,n,i,a,s=e;;){var{[me]:o,[pe]:l}=s
...
class we{constructor(){this.stack=null,this.positional=new Re,this.named=new Pe,this.blocks=new xe}empty(e){var t=e[v][a.$sp]+1
...
if((0,o.managerHasCapability)(g,_,4)){var E=s.blocks.values,O=s.blocks.names,w=g.prepareArgs(y,s)
if(w){s.clear()
for(var T=0;T<E.length;T++)n.push(E[T])
for(var{positional:R,named:P}=w,k=R.length,C=0;C<k;C++)n.push(R[C])
for(var x=Object.keys(P),S=0;S<x.length;S++)n.push(P[x[S]])
s.setup(n,x,O,k,!1)}n.push(s)}else n.push(s)})),ce.add(87,((e,{op1:t,op2:r})=>{var n=e.fetchValue(r),{definition:i,manager:a,capabilities:s}=n
...
y[O]=w}}if(g)for(var T=0;T<m.length;T++){var R=T+1,P=g[m[T]]
void 0!==P&&v.bind(R,P)}v.bindPartialMap(y),e.pushFrame(),e.call((0,t.unwrapHandle)(f))})),ce.add(72,((e,{op1:t,op2:n})=>{var i=e.stack,a=i.pop(),s=i.pop(),o=(0,r.valueForRef)(s),l=null===o?"@identity":String(o),u=(0,r.createIteratorRef)(a,l),c=(0,r.valueForRef)(u)
...
var wt=Ot
wt=bt(Et,wt)
var Tt=wt=gt(Et,wt,"http://www.w3.org/2000/svg")
e.DOMChanges=Tt
...
new Lt(t,{alwaysRevalidate:e}).execute(r,this)}parentElement(){return this.bounds.parentElement()}firstNode(){return this.bounds.firstNode()}lastNode(){return this.bounds.lastNode()}handleException(){throw"this should never happen"}}class qt{constructor(){this.scope=new t.Stack,this.dynamicScope=new t.Stack,this.updating=new t.Stack,this.cache=new t.Stack,this.list=new t.Stack}}class Yt{constructor(e,{pc:r,scope:n,dynamicScope:i,stack:s},o,l){this.runtime=e,this.elementStack=o,this.context=l,this[St]=new qt,this[At]=new t.Stack,this.s0=null,this.s1=null,this.t0=null,this.t1=null,this.v0=null,this.resume=Wt(this.context)
...
Object.defineProperty(e,"__esModule",{value:!0}),e.bump=function(){h++},e.createTag=function(){return new b(0)},e.createUpdatableTag=E,e.isConstTag=w,e.validateTag=m,e.valueForTag=f,e.dirtyTagFor=M,e.tagFor=I,e.tagMetaFor=N,e.beginTrackFrame=U,e.endTrackFrame=B,e.beginUntrackFrame=z,e.endUntrackFrame=V,e.resetTracking=function(){for(;F.length>0;)F.pop()
...
try{e[q]=t()}finally{r=B(),e[Y]=r,e[G]=f(r),$(r)}}return e[q]},e.trackedData=function(e,t){var r=new WeakMap,n="function"==typeof t
...
return 2===arguments.length?(t=arguments[0],i=arguments[1],e=null):([e,t,n]=g(...arguments),void 0===n?i=0:s(i=n.pop())||(r=!0===i,i=n.pop())),[e,t,n,i=parseInt(i,10),r]}var y=0,_=0,E=0,O=0,w=0,T=0,R=0,P=0,k=0,C=0,x=0,S=0,A=0,j=0,M=0,N=0,I=0,D=0,L=0,F=0,U=0
...
this._platform=r(this._boundAutorunEnd)}get counters(){return{begin:_,end:E,events:{begin:O,end:0},autoruns:{created:D,completed:L},run:w,join:T,defer:R,schedule:P,scheduleIterable:k,deferOnce:C,scheduleOnce:x,setTimeout:S,later:A,throttle:j,debounce:M,cancelTimers:N,cancel:I,loops:{total:F,nested:U}}}get defaultQueue(){return this._defaultQueue}begin(){_++
...
return n[r]=function(e,r){e?m(l,e):void 0===t?h(l,r):!0===t?h(l,P(arguments)):Array.isArray(t)?h(l,R(arguments,t)):h(l,r)},i?S(l,n,e,this):x(l,n,e,this)}
...
for(var ge in a("instrument",!0),ve)ve.hasOwnProperty(ge)&&fe(ge,ve[ge])}var be={asap:K,cast:he,Promise:T,EventTarget:n,all:A,allSettled:M,race:N,hash:D,hashSettled:F,rethrow:U,defer:B,denodeify:C,configure:a,on:fe,off:me,resolve:$,reject:H,map:V,async:pe,filter:G}
...
var a=i
e.default=a})),define("ember-concurrency-ts/async",[],(function(){})),define("ember-concurrency-ts/index",["exports","@ember/debug"],(function(e,t){"use strict"
...
let v=0
function g(e,t,r,n,i,a){if(r)for(let s=0;s<r.length;++s){let o=r[s],l="__ember_concurrency_handler_"+v++
...
r=new f.default(e,n)}return{context:e,debug:this._debug,name:this.name,group:t,scheduler:r,hasEnabledEvents:this._hasEnabledEvents,onStateCallback:n}}get taskFn(){return this.taskDefinition}set taskFn(e){this.setTaskDefinition(e)}}e.TaskFactory=E
e.TaskGroupFactory=class extends E{createTaskGroup(e){let t=this._sharedTaskProperties(e)
...
let u=new a.TaskInstance({task:this,args:e,executor:new s.TaskInstanceExecutor({generatorFactory:()=>l.perform.apply(l,e),env:o.EMBER_ENVIRONMENT,debug:this.debug}),performType:n,hasEnabledEvents:this.hasEnabledEvents})
...
Object.defineProperty(e,"restartableTaskGroup",{enumerable:!0,get:function(){return c.restartableTaskGroup}})})),define("ember-ecsy-babylon/component-managers/domless-glimmer",["exports","@ember/application","@ember/component","@ember/destroyable"],(function(e,t,r,n){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
const i=(0,r.capabilities)("3.13",{destructor:!0,asyncLifecycleCallbacks:!1,updateHook:!0})
function a(e){return Object.freeze({...e})}e.default=class{static create(e){return new this((0,t.getOwner)(e))}constructor(e){var r,n,a
a=i,(n="capabilities")in(r=this)?Object.defineProperty(r,n,{value:a,enumerable:!0,configurable:!0,writable:!0}):r[n]=a,(0,t.setOwner)(this,e)}createComponent(e,r){const i=new e((0,t.getOwner)(this),r.named)
return(0,n.registerDestructor)(i,(e=>e._willDestroy())),{previousArgs:a(r.named),instance:i}}updateComponent(e,t){const r=a(t.named),{instance:n,previousArgs:i}=e
if(void 0===r)return
const s=Object.keys(r).filter((e=>r[e]!==i[e])).reduce(((e,t)=>({...e,[t]:r[t]})),{})
Object.keys(s).length>0&&n.didUpdate(s),e.previousArgs=r}destroyComponent(e){const{instance:t}=e;(0,n.destroy)(t)}getContext(e){return e.instance}}})),define("ember-ecsy-babylon/components/domless-glimmer",["exports","@ember/component","ember-ecsy-babylon/component-managers/domless-glimmer","@ember/application","@ember/destroyable"],(function(e,t,r,n,i){"use strict"
...
const s=Symbol("will_destroy")
class o{constructor(e,t){a(this,"args",void 0),a(this,"children",void 0),a(this,"_context",void 0),a(this,s,!1),this.args=t,this.children=new Set,(0,n.setOwner)(this,e),this.args.parent&&this.args.parent.registerChild(this)}get isDestroying(){return(0,i.isDestroying)(this)}get isDestroyed(){return(0,i.isDestroyed)(this)}get context(){return void 0!==this._context?this._context:this.args.parent&&this.args.parent.context}set context(e){this._context=e}didUpdate(e){}willDestroy(){Array.from(this.children).reverse().forEach((e=>{e[s]||(e[s]=!0,e.willDestroy())}))}_willDestroy(){this.args.parent&&this.args.parent.unregisterChild(this),this[s]||(this[s]=!0,this.willDestroy())}registerChild(e){this.children.add(e)}unregisterChild(e){this.children.delete(e)}}e.default=o,(0,t.setComponentManager)((e=>new r.default(e)),o)})),define("ember-ecsy-babylon/components/ecsy-babylon",["exports","@ember/component","@ember/template-factory","ember-ecsy-babylon/components/ecsy","ecsy-babylon/components/babylon-core","@ember/object","@glimmer/tracking","@ember/debug","@babylonjs/core/Engines/engine"],(function(e,t,r,n,i,a,s,o,l){"use strict"
var u,c
...
const p=(0,r.createTemplateFactory)({id:"ViX66RZ8",block:'[[[11,"canvas"],[16,1,[29,[[30,0,["guid"]],"__canvas"]]],[24,"tabindex","0"],[17,1],[4,[38,0],[[30,0,["onCanvasReady"]]],null],[4,[38,1],["keypress",[30,0,["toggleBabylonInspector"]]],null],[4,[38,2],[[30,0,["resize"]]],null],[12],[1,"\\n"],[41,[48,[30,2]],[[[41,[30,0,["ready"]],[[[1,"      "],[18,2,[[50,"ecsy-babylon/scene",0,null,[["parent"],[[30,0]]]]]],[1,"\\n"]],[]],null],[1,"    "],[18,3,null],[1,"\\n"]],[]],[[[41,[30,0,["ready"]],[[[1,"      "],[18,4,[[50,"ecsy-babylon/scene",0,null,[["parent"],[[30,0]]]]]],[1,"\\n"]],[]],null]],[]]],[13],[1,"\\n"]],["&attrs","&ecsy","&html","&default"],false,["did-insert","on","on-resize","if","has-block","yield","component"]]',moduleName:"ember-ecsy-babylon/components/ecsy-babylon.hbs",isStrictMode:!1})
let f=(u=class extends n.default{constructor(e,t){var r,n,i,a
super(e,t),d(this,"entity",void 0),d(this,"scene",void 0),d(this,"engine",void 0),d(this,"debugLayer",void 0),r=this,n="ready",a=this,(i=c)&&Object.defineProperty(r,n,{enumerable:i.enumerable,configurable:i.configurable,writable:i.writable,value:i.initializer?i.initializer.call(a):void 0}),this.entity=this.world.createEntity(),this.context.rootEntity=this.entity}onCanvasReady(e){const t=new l.Engine(e,this.args.antialias,this.args.engineOptions,this.args.adaptToDeviceRatio)
...
this.scene=r.scene,this.engine=t}resize(){var e
null===(e=this.engine)||void 0===e||e.resize()}async toggleBabylonInspector(e){0}willDestroy(){super.willDestroy()
const e=this.entity
e&&e.remove(),this.world.execute(0,0),this.world.stop()}},c=h(u.prototype,"ready",[s.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),h(u.prototype,"onCanvasReady",[a.action],Object.getOwnPropertyDescriptor(u.prototype,"onCanvasReady"),u.prototype),h(u.prototype,"resize",[a.action],Object.getOwnPropertyDescriptor(u.prototype,"resize"),u.prototype),h(u.prototype,"toggleBabylonInspector",[a.action],Object.getOwnPropertyDescriptor(u.prototype,"toggleBabylonInspector"),u.prototype),u)
e.default=f,(0,t.setComponentTemplate)(p,f)})),define("ember-ecsy-babylon/components/ecsy-babylon/load-gltf",["exports","@ember/component","@ember/template-factory","ember-ecsy-babylon/components/domless-glimmer","@ember/debug"],(function(e,t,r,n,i){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
const a=(0,r.createTemplateFactory)({id:"wgke1JAh",block:'[[[8,[39,0],null,[["@parent","@files"],[[30,0],[28,[37,1],null,[["file"],[[30,1]]]]]],[["default"],[[[[1,"\\n  "],[18,3,[[28,[37,3],[[30,2],"file"],null],[30,0]]],[1,"\\n"]],[2]]]]]],["@file","ach","&default"],false,["ecsy-babylon/load-gltfs","hash","yield","get"]]',moduleName:"ember-ecsy-babylon/components/ecsy-babylon/load-gltf.hbs",isStrictMode:!1})
class s extends n.default{constructor(e,t){super(e,t)}}e.default=s,(0,t.setComponentTemplate)(a,s)})),define("ember-ecsy-babylon/components/ecsy-babylon/load-gltfs",["exports","@ember/component","@ember/template-factory","ember-ecsy-babylon/components/domless-glimmer","@ember/debug","ecsy-babylon/components/babylon-core","ember-concurrency","ember-concurrency-ts","@glimmer/tracking","@babylonjs/loaders/glTF/glTFFileLoader","@babylonjs/loaders/glTF/2.0/glTFLoader","@babylonjs/core/Loading/sceneLoader"],(function(e,t,r,n,i,a,s,o,l,u,c,d){"use strict"
var h,p
function f(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function m(e,t,r,n,i){var a={}
return Object.keys(n).forEach((function(e){a[e]=n[e]})),a.enumerable=!!a.enumerable,a.configurable=!!a.configurable,("value"in a||a.initializer)&&(a.writable=!0),a=r.slice().reverse().reduce((function(r,n){return n(e,t,r)||r}),a),i&&void 0!==a.initializer&&(a.value=a.initializer?a.initializer.call(i):void 0,a.initializer=void 0),void 0===a.initializer&&(Object.defineProperty(e,t,a),a=null),a}Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
const v=(0,r.createTemplateFactory)({id:"NU9IkHj1",block:'[[[41,[30,0,["assets"]],[[[1,"  "],[18,1,[[30,0,["assets"]],[30,0]]],[1,"\\n"]],[]],null]],["&default"],false,["if","yield"]]',moduleName:"ember-ecsy-babylon/components/ecsy-babylon/load-gltfs.hbs",isStrictMode:!1})
d.SceneLoader.RegisterPlugin(new u.GLTFFileLoader)
let g=(h=class extends n.default{constructor(e,t){var r,n,i,s
super(e,t),r=this,n="assets",s=this,(i=p)&&Object.defineProperty(r,n,{enumerable:i.enumerable,configurable:i.configurable,writable:i.writable,value:i.initializer?i.initializer.call(s):void 0}),f(this,"core",void 0),f(this,"assetContainerHash",void 0),f(this,"fileHash",void 0)
const l=this.context.rootEntity.getComponent(a.default)
this.core=l,this.fileHash=this.args.files,(0,o.perform)(this.loadModels,this.args.files)}didUpdate(e){if(e.files){const{files:e}=this.args,t=Object.keys(e).filter((t=>e[t]!==this.fileHash[t])).reduce(((t,r)=>({...t,[r]:e[r]})),{})
...
this.assets=void 0,this.assetContainerHash=void 0,this.cleanup(e)}*loadModel(e){const{scene:t}=this.core
if(e)try{return yield d.SceneLoader.LoadAssetContainerAsync(e,"",t)}catch(r){console.error(`Failed to load "${e}": ${r.message}`)}return null}*loadModels(e){const t=Object.entries(e).reduce(((e,[t,r])=>({...e,[t]:(0,o.perform)(this.loadModel,r)})),{}),r=yield(0,s.hash)(t)
if(!r)throw new Error("Failed to load files")
this.setup(r)}setup(e){const t=[]
Object.entries(this.assetContainerHash||{}).forEach((([r,n])=>{Object.prototype.hasOwnProperty.call(e,r)&&n&&t.push(n)})),this.assetContainerHash={...this.assetContainerHash,...e},this.assets=Object.entries(this.assetContainerHash).reduce(((e,[t,r])=>({...e,[t]:r?{meshes:r.meshes.filter((e=>e.getTotalVertices()>0)),materials:r.materials}:null})),{}),this.core.engine.onEndFrameObservable.addOnce((()=>this.cleanup(t)))}cleanup(e){e.forEach((e=>{e.dispose()}))}},p=m(h.prototype,"assets",[l.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),m(h.prototype,"loadModel",[s.task],Object.getOwnPropertyDescriptor(h.prototype,"loadModel"),h.prototype),m(h.prototype,"loadModels",[s.restartableTask],Object.getOwnPropertyDescriptor(h.prototype,"loadModels"),h.prototype),h)
e.default=g,(0,t.setComponentTemplate)(v,g)})),define("ember-ecsy-babylon/components/ecsy-babylon/scene",["exports","@ember/component","@ember/template-factory","ember-ecsy-babylon/components/domless-glimmer","@ember/debug","ecsy-babylon/components/babylon-core","@babylonjs/core/Materials/Textures/cubeTexture","@babylonjs/core/Materials/Textures/hdrCubeTexture","@babylonjs/core/Maths/math.vector"],(function(e,t,r,n,i,a,s,o,l){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
const u=(0,r.createTemplateFactory)({id:"0q3zFBMC",block:'[[[18,1,[[28,[37,1],null,[["Entity","LoadGltf","LoadGltfs","scene"],[[50,"ecsy/entity",0,null,null],[50,"ecsy-babylon/load-gltf",0,null,null],[50,"ecsy-babylon/load-gltfs",0,null,null],[30,0,["scene"]]]]],[30,0]]]],["&default"],false,["yield","hash","component"]]',moduleName:"ember-ecsy-babylon/components/ecsy-babylon/scene.hbs",isStrictMode:!1})
...
const{environmentTexture:s,environmentRotation:o,...l}=t,{world:u,rootEntity:c}=this.context,d=c.getComponent(a.default)
this.scene=d.scene,Object.assign(this.scene,l),this.updateEnvironmentTexture(s),this.rotateEnvironmentTexture(o)}didUpdate(e){super.didUpdate(e)
...
this.scene.environmentTexture=e?new s.CubeTexture(e,this.scene):null,t&&t.dispose()}rotateEnvironmentTexture(e=0){const t=this.scene.environmentTexture
t&&(t instanceof s.CubeTexture||t instanceof o.HDRCubeTexture)&&t.setReflectionTextureMatrix(l.Matrix.RotationY(e))}willDestroy(){this.scene.environmentTexture&&(this.scene.environmentTexture.dispose(),this.scene.environmentTexture=null),super.willDestroy()}}e.default=c,(0,t.setComponentTemplate)(u,c)})),define("ember-ecsy-babylon/components/ecsy",["exports","@ember/component","@ember/template-factory","ember-ecsy-babylon/components/domless-glimmer","@ember/debug","ecsy-babylon/components/parent","ecsy-babylon/world"],(function(e,t,r,n,i,a,s){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
class l extends n.default{constructor(e,t){var r,n,i
super(e,t),i=void 0,(n="world")in(r=this)?Object.defineProperty(r,n,{value:i,enumerable:!0,configurable:!0,writable:!0}):r[n]=i
const{components:o,systems:l}=this.args
this.world=new s.default,o.forEach((e=>this.world.registerComponent(e))),this.world.hasRegisteredComponent(a.default)||this.world.registerComponent(a.default),l.forEach((e=>this.world.registerSystem(e))),this.context={world:this.world,components:o}}}e.default=l,(0,t.setComponentTemplate)(o,l)})),define("ember-ecsy-babylon/components/ecsy/ecsy-component",["exports","@ember/debug","ember-ecsy-babylon/components/domless-glimmer","ember-ecsy-babylon/components/ecsy/entity"],(function(e,t,r,n){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
const{parent:a,name:s,...o}=t,l=this.context.components
if(!l.has(s))throw new Error(`Ecsy component "${s}" not found. Available component names: ${Array.from(l.keys()).join(", ")}`)
this._Component=l.get(s),a.entity.addComponent(this._Component,o)}didUpdate(e){super.didUpdate(e)
const{parent:t}=this.args,r=this._Component.schema,n=t.entity.getMutableComponent(this._Component)
for(const[i,a]of Object.entries(e)){const e=r[i]
n[i]=e?e.type.copy(a,n[i]):a}}willDestroy(){super.willDestroy(),this._Component&&this.args.parent.entity.removeComponent(this._Component)}}e.default=i})),define("ember-ecsy-babylon/components/ecsy/entity",["exports","@ember/component","@ember/template-factory","@ember/debug","ecsy-babylon/components/parent","ember-ecsy-babylon/components/domless-glimmer"],(function(e,t,r,n,i,a){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
const s=(0,r.createTemplateFactory)({id:"HLY+X3Zi",block:'[[[41,[30,0,["entity"]],[[[1,"  "],[18,1,[[30,0]]],[1,"\\n"]],[]],null]],["&default"],false,["if","yield"]]',moduleName:"ember-ecsy-babylon/components/ecsy/entity.hbs",isStrictMode:!1})
class o extends a.default{constructor(e,t){var r,n,a
super(e,t),a=void 0,(n="entity")in(r=this)?Object.defineProperty(r,n,{value:a,enumerable:!0,configurable:!0,writable:!0}):r[n]=a
const s=function(e){let t=e.args.parent
for(;t;){if(t instanceof o)return t
t=t.args.parent}return null}(this),l=s?s.entity:void 0,u=this.context.world.createEntity()
u.addComponent(i.default,{value:l}),this.entity=u}willDestroy(){super.willDestroy(),this.entity.remove()}}e.default=o,(0,t.setComponentTemplate)(s,o)})),define("ember-ecsy-babylon/helpers/color",["exports","@ember/component/helper","@babylonjs/core/Maths/math.color"],(function(e,t,r){"use strict"
...
super(...e),n=void 0,(r="texture")in(t=this)?Object.defineProperty(t,r,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[r]=n}compute([e,...t],r){return this.texture&&this.texture.dispose(),this.texture=new e(...t),Object.assign(this.texture,r),this.texture}willDestroy(){this.texture&&this.texture.dispose(),super.willDestroy()}}e.default=r})),define("ember-ecsy-babylon/helpers/get-bounding-info",["exports","@ember/component/helper"],(function(e,t){"use strict"
function r([e]){return e.getBoundingInfo()}Object.defineProperty(e,"__esModule",{value:!0}),e.getBoundingInfo=r,e.default=void 0
var n=(0,t.helper)(r)
...
super(...e),n=void 0,(r="texture")in(t=this)?Object.defineProperty(t,r,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[r]=n}compute(e,t){return this.texture&&this.texture.dispose(),this.texture=new r.Texture(...e),Object.assign(this.texture,t),this.texture}willDestroy(){this.texture&&this.texture.dispose(),super.willDestroy()}}e.default=n})),define("ember-ecsy-babylon/helpers/vector",["exports","@ember/component/helper","@babylonjs/core/Maths/math.vector"],(function(e,t,r){"use strict"
function n(e,{deg:t=!1}={}){t&&(e=e.map((e=>e/180*Math.PI)))
const[n,i,a,s]=e
switch(e.length){case 2:return new r.Vector2(n,i)
case 3:return new r.Vector3(n,i,a)
case 4:return new r.Vector4(n,i,a,s)
default:throw new Error("Unknown amount of arguments provided")}}Object.defineProperty(e,"__esModule",{value:!0}),e.vector=n,e.default=void 0
var i=(0,t.helper)(n)
e.default=i})),define("ember-ecsy-babylon/index",["exports","@ember/string"],(function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.mapComponentImports=function(e){return new Map(Object.entries(e).filter((([e])=>"default"!==e)).filter((([,e])=>null==e?void 0:e.isComponent)).map((([e,r])=>[(0,t.dasherize)(e).toLowerCase(),r])))}})),define("ember-load-initializers/index",["exports","require"],(function(e,t){"use strict"
...
super(...e),t=this,r="resizeObserver",i=this,(n=s)&&Object.defineProperty(t,r,{enumerable:n.enumerable,configurable:n.configurable,writable:n.writable,value:n.initializer?n.initializer.call(i):void 0})}get callback(){return this.args.positional[0]}didReceiveArguments(){}didInstall(){this.resizeObserver.observe(this.element,this.handleResize)}willRemove(){this.resizeObserver.unobserve(this.element,this.handleResize)}handleResize(...e){this.callback(...e)}},s=o(a.prototype,"resizeObserver",[r.inject],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),o(a.prototype,"handleResize",[n.action],Object.getOwnPropertyDescriptor(a.prototype,"handleResize"),a.prototype),a)
e.default=l}))
