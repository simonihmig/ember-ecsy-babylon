...
var Y,G=function(e,t,r,n){var i,s=arguments.length,a=s<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,r,n)
else for(var o=e.length-1;o>=0;o--)(i=e[o])&&(a=(s<3?i(a):s>3?i(t,r,a):i(t,r))||a)
return s>3&&a&&Object.defineProperty(t,r,a),a}
if(c.hasDOM){var W=Object.create(null),Q=document.createElement("input")
W[""]=!1,W.text=!0,W.checkbox=!0,Y=e=>{var t=W[e]
if(void 0===t){try{Q.type=e,t=Q.type===e}catch(r){t=!1}finally{Q.type="text"}W[e]=t}return t}}else Y=e=>""!==e
...
return function(){return je(e,(0,a.valueForRef)(t),(0,a.valueForRef)(r),n,i)(...arguments)}}((0,a.valueForRef)(i),c,s,d,l),Pe.add(t),(0,a.createUnboundRef)(t,"(result of an `action` helper)")}))
...
if(c&&c.length)(function(e,t,r,i){for(var s=[],o=e.length-1;-1!==o;){var u=Oe(e[o]),l=u[1];-1===s.indexOf(l)&&(s.push(l),Ee(t,r,u,i)),o--}if(-1===s.indexOf("id")){var c=t.elementId?t.elementId:(0,n.guidFor)(t)
...
r.setAttribute("class",m,!1,null)}p&&p.length&&p.forEach((e=>{r.setAttribute("class",(0,a.createPrimitiveRef)(e),!1,null)})),h&&h.length&&h.forEach((e=>{we(l,e,r)})),r.setAttribute("class",qe,!1,null),"ariaRole"in i&&r.setAttribute("role",(0,a.childRefFor)(l,"ariaRole"),!1,null),i._transitionTo("hasElement"),u&&((0,o.beginUntrackFrame)(),i.trigger("willInsertElement"),(0,o.endUntrackFrame)())}didRenderLayout(e,t){e.component[ze]=t,e.finalize()}didCreate(e){var{component:t,isInteractive:r}=e
...
function We(e){return e===Ge}var Qe,Ke=new WeakMap
...
u.engine=d,p&&(u.engineBucket={mountPoint:p})}}return u}getDebugName(e){var{name:t}=e
...
class bt{constructor(e){this.handle=-1,this.resolvedName="-top-level",this.capabilities=(0,s.capabilityFlagsFrom)(gt),this.compilable=null,this.manager=new vt(e),this.state=(0,w.getFactoryFor)(e)}}class yt{constructor(e){this.inner=e}}var _t=Re((e=>{var{positional:t}=e,r=t[0]
...
class At{constructor(e,t){this.owner=e,this.isInteractive=t,this.enableDebugTooling=E.ENV._DEBUG_RENDER_TREE}onTransactionCommit(){}}var jt=Re((e=>{var{positional:t,named:r}=e,n=t[0],i=r.type,s=r.loc,o=r.original;(0,a.valueForRef)(i),(0,a.valueForRef)(s),(0,a.valueForRef)(o)
...
return!0===s?(0,v.dasherize)(i):s||0===s?String(s):""}))})),Nt=Re(((e,t)=>{var r,{positional:n}=e,i=n[0],s=(0,a.valueForRef)(i)
return(0,a.createConstRef)(null===(r=t.factoryFor(s))||void 0===r?void 0:r.class,`(-resolve "${s}")`)})),It=Re((e=>{var{positional:t}=e,r=t[0]
return(0,a.createComputeRef)((()=>{var e=(0,a.valueForRef)(r)
return(0,n.isObject)(e)&&(0,o.consumeTag)((0,u.tagForProperty)(e,"[]")),e}))})),Dt=Re((e=>{var{positional:t}=e,r=t[0]
return(0,a.createInvokableRef)(r)})),Lt=Re((e=>{var{positional:t}=e,r=t[0]
return(0,a.createReadOnlyRef)(r)})),Ft=Re((e=>{var{positional:t,named:r}=e
return(0,a.createUnboundRef)((0,a.valueForRef)(t[0]),"(result of an `unbound` helper)")})),Ut=Re((()=>(0,a.createConstRef)(([1e7]+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,(e=>(e^16*Math.random()>>e/4).toString(16))),"unique-id")))
...
s.boot()
var o,u,l,c=s.factoryFor("controller:application")||(0,R.generateControllerFactory)(s,"application")
...
class Wt{constructor(e){this.resolvedName=e,this.handle=-1,this.manager=Gt,this.compilable=null,this.capabilities=(0,s.capabilityFlagsFrom)(Yt),this.state={name:e}}}var Qt=Re(((e,t)=>{var r,n,i,s=e.positional[0]
...
return s}))}))
function Xt(e){return{object:`component:${e}`}}var Jt={action:Ce,mut:Dt,readonly:Lt,unbound:Ft,"-hash":_.hash,"-each-in":_t,"-normalize-class":Mt,"-resolve":Nt,"-track-array":It,"-mount":Qt,"-outlet":Kt,"-in-el-null":St},Zt=Object.assign(Object.assign({},Jt),{array:_.array,concat:_.concat,fn:_.fn,get:_.get,hash:_.hash})
...
if(null===n.component)if(E.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS)l={state:(0,_.templateOnlyComponent)(void 0,e),manager:_.TEMPLATE_ONLY_COMPONENT_MANAGER,template:a}
...
Object.defineProperty(e,"__esModule",{value:!0}),e.TrackedDescriptor=e.SYNC_OBSERVERS=e.PROXY_CONTENT=e.PROPERTY_DID_CHANGE=e.NAMESPACES_BY_ID=e.NAMESPACES=e.Mixin=e.Libraries=e.DEBUG_INJECTION_FUNCTIONS=e.ComputedProperty=e.ASYNC_OBSERVERS=void 0,e._getPath=Pe,e._getProp=Re,e._setProp=je,e.activateObserver=T,e.addArrayObserver=function(e,t,r){return G(e,t,r,f)},e.addListener=f,e.addNamespace=function(e){Ve.unprocessedNamespaces=!0,Ye.push(e)},e.addObserver=O,e.alias=function(e){return se(new Ne(e),Me)},e.applyMixin=ct,e.arrayContentDidChange=q,e.arrayContentWillChange=z,e.autoComputed=function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r]
...
return Ge[e]},e.findNamespaces=We
...
var i=t.pop(),s=t
return(0,r.setListeners)(i,s),i},e.processAllNamespaces=Ke,e.processNamespace=Qe,e.removeArrayObserver=function(e,t,r){return G(e,t,r,m)},e.removeListener=m,e.removeNamespace=function(e){var t=(0,r.getName)(e)
...
return o.CONSTANT_TAG},e.tagForProperty=M,e.tracked=gt,e.trySet=function(e,t,r){return Ae(e,t,r,!0)}
...
null!==o&&(o.isPrototypeMeta(e)||o.isInitializing())||T(e,a,s)}function E(e,r,n,i,s){void 0===s&&(s=b)
var a=g(r),o=(0,t.peekMeta)(e)
null!==o&&(o.isPrototypeMeta(e)||o.isInitializing())||R(e,a,s),m(e,a,n,i)}function w(e,t){var r=!0===t?y:_
...
return s}function N(e,t){(0,o.dirtyTagFor)(e,t),(0,o.dirtyTagFor)(e,S)}var I=Symbol("PROPERTY_DID_CHANGE")
e.PROPERTY_DID_CHANGE=I
var D=0
function L(e,r,n,i){var s=void 0===n?(0,t.peekMeta)(e):n
null!==s&&(s.isInitializing()||s.isPrototypeMeta(e))||(N(e,r),D<=0&&A(),I in e&&(4===arguments.length?e[I](r,i):e[I](r)))}function F(){D++,k=!0}function U(){--D<=0&&(A(),function(){for(var[e,t,r]of(k=!1,x))R(e,t,r)
x=[]}())}function B(e){F()
...
return n(e,"@array:before",t,s),n(e,"@array:change",t,a),null===(i=e._revalidate)||void 0===i||i.call(e),e}var W=new l._WeakSet
...
if(l=null!==p?p.peekDescriptors(u):void 0,e.push(y),f===h){W.has(l)&&c[u]
...
u&&o.teardown(e,r,a),le(n)?_e(e,r,n,a):null==n?Oe(e,r,i,u,!0):Object.defineProperty(e,r,n),a.isPrototypeMeta(e)||P(e)}function _e(e,t,r,n){var i
...
var Ce={}
function Ae(e,t,r,n){return e.isDestroyed?r:we(t)?Se(e,t,r,n):je(e,t,r)}function je(e,t,n){var i,s=(0,r.lookupDescriptor)(e,t)
return null!==s&&ie.has(s.set)?(e[t]=n,n):(void 0!==(i=e[t])||"object"!=typeof e||t in e||"function"!=typeof e.setUnknownProperty?(e[t]=n,i!==n&&L(e,t)):e.setUnknownProperty(t,n),n)}function Se(e,t,r,n){var i=t.split("."),s=i.pop(),a=Pe(e,i)
...
t._meta=e}}class Ne extends te{constructor(e){super(),this.altKey=e}setup(e,t,r,n){super.setup(e,t,r,n),W.add(this)}get(e,r){var n,i=(0,t.meta)(e),s=(0,o.tagMetaFor)(e),a=(0,o.tagFor)(e,r,s);(0,o.untrack)((()=>{n=xe(e,this.altKey)}))
...
function We(){if(Ve.unprocessedNamespaces){var e,t=i.context.lookup,n=Object.keys(t)
...
if(e&&(We(),Ve.unprocessedNamespaces=!1),e||He){var t=Ye
for(var r of t)Qe(r)
...
"function"==typeof l?(a=!0,s[u]=it(u,l,i,{})):s[u]=l}return a&&(s._super=r.ROOT),s}function ot(e,t,r,n,i,s,a){for(var o,u=0;u<e.length;u++)if(o=e[u],pt.has(o)){if(t.hasMixin(o))continue
t.addMixin(o)
var{properties:l,mixins:c}=o
void 0!==l?ut(t,l,r,n,i,s,a):void 0!==c&&(ot(c,t,r,n,i,s,a),o instanceof ht&&void 0!==o._without&&o._without.forEach((e=>{var t=s.indexOf(e);-1!==t&&s.splice(t,1)})))}else ut(t,o,r,n,i,s,a)}function ut(e,t,r,n,i,s,a){var o=rt("concatenatedProperties",t,n,i),u=rt("mergedProperties",t,n,i),l=Object.keys(t)
for(var c of l){var d=t[c]
if(void 0!==d){if(-1===s.indexOf(c)){s.push(c)
var p=e.peekDescriptors(c)
if(void 0===p){var h=n[c]=i[c]
"function"==typeof h&&lt(i,c,h,!1)}else r[c]=p,a.push(c),p.teardown(i,c,e)}var f="function"==typeof d
if(f){var m=ue(d)
if(void 0!==m){r[c]=nt(c,d,m,r),n[c]=void 0
continue}}o&&o.indexOf(c)>=0||"concatenatedProperties"===c||"mergedProperties"===c?d=st(c,d,n):u&&u.indexOf(c)>-1?d=at(c,d,n):f&&(d=it(c,d,n,r)),n[c]=d,r[c]=void 0}}}function lt(e,t,n,i){var s=(0,r.observerListenerMetaFor)(n)
...
for(var c of(e._super=r.ROOT,ot(n,o,s,a,e,u,l),u)){var d=a[c],p=s[c]
void 0!==d?("function"==typeof d&&lt(e,c,d,!0),Oe(e,c,d,-1!==l.indexOf(c),!i)):void 0!==p&&_e(e,c,p,o)}return o.isPrototypeMeta(e)||P(e),e}var dt,pt=new l._WeakSet
...
return ce(a),a}return bt(t)}function bt(e){var[n,i,s]=e,{getter:a,setter:u}=(0,o.trackedData)(i,s?s.initializer:void 0)
...
return ie.add(c),(0,t.meta)(n).writeDescriptors(i,new yt(l,c)),d}e.Mixin=ht,e.DEBUG_INJECTION_FUNCTIONS=dt
...
class p extends(s.default.extend(r.Evented)){get _router(){var e=this[c]
...
_=E(_)
var O=v.type||(0,s.typeOf)(_),w=this.serializeQueryParam(_,y,O),T=`${t}:${m}`,k={undecoratedDefaultValue:(0,r.get)(a,m),defaultValue:_,serializedDefaultValue:w,serializedValue:w,type:O,urlKey:y,prop:m,scopedPropertyName:T,controllerName:t,route:this,parts:b,values:null,scope:g}
...
e.NativeArray=x
var R,P=["length"]
x.keys().forEach((e=>{Array.prototype[e]&&P.push(e)})),e.NativeArray=x=x.without(...P),e.A=R,a.ENV.EXTEND_PROTOTYPES.Array?(x.apply(Array.prototype,!0),e.A=R=function(e){return e||[]}):e.A=R=function(e){return e||(e=[]),T.detect(e)?e:x.apply(e)}
var C=T
...
var n=E.get(e)
return void 0!==n&&E.set(r,n),r}var{toString:x}=Object.prototype,{toString:R}=Function.prototype,{isArray:P}=Array,{keys:C}=Object,{stringify:A}=JSON,j=100,S=/^[\w$]+$/
...
break}var a=i[s]
n+=`${N(String(a))}: ${M(e[a],t,r)}`}return n+=" }"}(e,r+1,n)}function N(e){return S.test(e)?e:A(e)}function I(e,t){var r=e
...
return r.boot(t).then((()=>r.visit(e))).catch((e=>{throw(0,s.run)(r,"destroy"),e}))}))}}var v=m
...
var r,n,i,s,a,o,u,l,c,d,p,h=()=>{}
e.scheduleRevalidate=h,e.scheduleDestroy=r,e.scheduleDestroyed=n,e.toIterator=i,e.toBool=s,e.getProp=a,e.setProp=o,e.getPath=u,e.setPath=l,e.warnIfStyleNotTrusted=c,e.assert=d,e.deprecate=p
var f,m
e.assertGlobalContextWasSet=f,e.testOverrideGlobalContext=m
var v=function(f){var m
e.scheduleRevalidate=h=f.scheduleRevalidate,e.scheduleDestroy=r=f.scheduleDestroy,e.scheduleDestroyed=n=f.scheduleDestroyed,e.toIterator=i=f.toIterator,e.toBool=s=f.toBool,e.getProp=a=f.getProp,e.setProp=o=f.setProp,e.getPath=u=f.getPath,e.setPath=l=f.setPath,e.warnIfStyleNotTrusted=c=f.warnIfStyleNotTrusted,e.assert=d=f.assert,e.deprecate=p=f.deprecate,"boolean"==typeof(null===(m=f.FEATURES)||void 0===m?void 0:m.DEFAULT_HELPER_MANAGER)&&(e.FEATURE_DEFAULT_HELPER_MANAGER=t=f.FEATURES.DEFAULT_HELPER_MANAGER)}
...
0
return a({disableAutoTracking:Boolean(t.disableAutoTracking)})},e.setComponentManager=function(e,t){return P(new S(e),t)},e.setComponentTemplate=function(e,t){0
0
...
if(void 0!==n)return n
r=E(r)}}function k(e,t){return w(_,e,t)}function x(e,t){return w(O,e,t)}var R=new g((()=>new b))
...
function A(e){return e.capabilities.asyncLifeCycleCallbacks}function j(e){return e.capabilities.updateHook}class S{constructor(e){this.factory=e,this.componentManagerDelegates=new WeakMap}getDelegateFor(e){var{componentManagerDelegates:t}=this,r=t.get(e)
...
!0===s.disableAutoTracking?(0,n.untrack)((()=>i.updateModifier(r,t))):i.updateModifier(r,t)}getDestroyable(e){return e}}e.CustomModifierManager=N
...
function E(e,t){if(void 0!==t&&0!==t.length)for(var r=0;r<t.length;r++)e(22,t[r])}function w(e,t){Array.isArray(t)?O.compile(e,t):(C(e,t),e(31))}function T(e,r,n,i){if(null!==r||null!==n){var s=k(e,r)<<4
i&&(s|=8)
var a=t.EMPTY_STRING_ARRAY
if(n){a=n[0]
for(var o=n[1],u=0;u<o.length;u++)w(e,o[u])}e(82,a,t.EMPTY_STRING_ARRAY,s)}else e(83)}function k(e,t){if(null===t)return 0
...
v(r)?e(1005,r,(t=>{A(e,t,n,i)})):(w(e,r),j(e,n,i))})),O.add(50,((e,t)=>{var[,n,i,s,a]=t;(function(e,t,n,i,s){e(0),T(e,i,s,!1),e(86),w(e,n),e(77,t,{type:2,value:void 0}),e(1),e(36,r.$v0)})(e,i,n,s,a)})),O.add(30,((e,t)=>{var[,r,n]=t
...
if(null!==o){var b=h.indexOf(B);-1!==b&&(M(e,o),f.push(b))}for(var y=0;y<g.length;y++){var _=g[y],O=h.indexOf(`&${_}`);-1!==O&&(M(e,c.get(_)),f.push(O))}if((0,i.hasCapability)(s,8)){var E=k(e,u)<<4
E|=8
var T=t.EMPTY_STRING_ARRAY
if(null!==l){T=l[0]
for(var x=l[1],R=0;R<x.length;R++){var P=h.indexOf(T[R])
w(e,x[R]),m.push(P)}}e(82,T,t.EMPTY_STRING_ARRAY,E),m.push(-1)}else if(null!==l)for(var C=l[0],A=l[1],j=0;j<A.length;j++){var S=C[j],N=h.indexOf(S);-1!==N&&(w(e,A[j]),m.push(N),v.push(S))}e(97,r.$s0),(0,i.hasCapability)(s,64)&&e(59);(0,i.hasCapability)(s,512)&&e(87,0|c.has("default"),r.$s0)
...
function K(e){return"string"==typeof e?e:Q[e]}function X(e){return"string"==typeof e?e:W[e]}function J(e){return null===e?null:[e[0].map((e=>`@${e}`)),e[1]]}G.add(3,((e,t)=>e(42,t[1]))),G.add(13,(e=>e(55))),G.add(12,(e=>e(54))),G.add(4,((e,t)=>{var[,n,i,s]=t
m(n)?e(1003,n,(t=>{e(0),T(e,i,s,!1),e(57,t),e(1)})):(w(e,n),e(0),T(e,i,s,!1),e(33,r.$fp,1),e(108),e(1))})),G.add(14,((e,t)=>{var[,r,n,i]=t
...
e(89),e(48,K(r))})),G.add(8,((e,t)=>{var[,r,n,i,s]=t
f(r)?e(1004,r,(t=>{z(e,t,n,null,i,s)})):q(e,r,n,null,i,s,!0,!0)})),G.add(18,((e,t)=>{var[,r,n]=t
...
g(n)?e(1007,n,{ifComponent(t){z(e,t,null,i,J(s),null)},ifHelper(t){e(0),A(e,t,i,s),e(3,c("cautious-non-dynamic-append")),e(1)}}):L(e,(()=>{w(e,n),e(106)}),(t=>{t(0,(()=>{e(81),e(79),$(e,{capabilities:!0,elementBlock:null,positional:i,named:s,atNames:!1,blocks:u(null)})})),t(1,(()=>{j(e,i,s,(()=>{e(3,c("cautious-non-dynamic-append"))}))}))}))}else e(0),w(e,r),e(3,c("cautious-append")),e(1)
else e(41,null==r?"":String(r))})),G.add(2,((e,t)=>{var[,r]=t
Array.isArray(r)?(e(0),w(e,r),e(3,c("trusting-append")),e(1)):e(41,null==r?"":String(r))})),G.add(6,((e,t)=>{var[,r,n,i,s]=t
f(r)?e(1004,r,(t=>{z(e,t,null,n,J(i),s)})):q(e,r,null,n,i,s,!1,!1)})),G.add(40,((e,t)=>{var[,n,i,s,a]=t
U(e,(()=>(w(e,i),void 0===a?P(e,void 0):w(e,a),w(e,s),e(33,r.$sp,0),4)),(()=>{e(50),N(e,n),e(56)}))})),G.add(41,((e,t)=>{var[,r,n,i]=t
return U(e,(()=>(w(e,r),e(71),1)),(()=>{N(e,n)}),i?()=>{N(e,i)}:void 0)})),G.add(42,((e,t)=>{var[,n,i,s,a]=t
return F(e,(()=>(i?w(e,i):P(e,null),w(e,n),2)),(()=>{e(72,l("BODY"),l("ELSE")),e(0),e(33,r.$fp,1),e(6,l("ITER")),e(1e3,"ITER"),e(74,l("BREAK")),e(1e3,"BODY"),I(e,s,2),e(34,2),e(4,l("FINALLY")),e(1e3,"BREAK"),e(1),e(73),e(4,l("FINALLY")),e(1e3,"ELSE"),a&&N(e,a)}))})),G.add(43,((e,t)=>{var[,n,i,s]=t
U(e,(()=>(w(e,n),e(33,r.$sp,0),e(71),2)),(()=>{I(e,i,1)}),(()=>{s&&N(e,s)}))})),G.add(44,((e,t)=>{var[,r,n]=t
I(e,n,k(e,r))})),G.add(45,((e,t)=>{var[,r,n]=t
if(r){var[i,s]=r
k(e,s),function(e,t,r){e(59),e(58,t),r(),e(60)}(e,i,(()=>{N(e,n)}))}else N(e,n)})),G.add(46,((e,t)=>{var[,r,n,i,s]=t
...
return new Z(r,x(e),{symbols:n,hasEval:i},t)}function te(e,t,r){var n=G,i=Y(r,t),{encoder:s,program:{constants:a,resolver:o}}=i
...
return new K(t,r)}(i,u,a)}function G(e,t,r){return q(e,t)?new J(r):new Q(r)}class W{constructor(e){this.attribute=e}}e.DynamicAttribute=W
...
break}a=u}return{definition:n,owner:i,resolved:s,positional:t,named:r}}function Ee(e,t,r,n,i){return void 0===i&&(i=!1),new _e(e,t,r,n,i)}e.CurriedValue=_e
class we{constructor(){this.stack=null,this.positional=new ke,this.named=new xe,this.blocks=new Ce}empty(e){var t=e[v][s.$sp]+1
...
return a===u||(l=ye(a,e)?s?Ee(e,a,i,s):s:0===e&&"string"==typeof a&&a||(0,t.isObject)(a)?Ee(e,a,i,s):null,u=a),l}))}(i,u,c,l))})),ce.add(107,(e=>{var n,a=e.stack,o=a.pop(),u=a.pop().capture(),l=e.getOwner(),c=(0,r.createComputeRef)((()=>{void 0!==n&&(0,i.destroy)(n)
...
e.elements().setStaticAttribute(s,a,o)})),ce.add(52,((e,t)=>{var{op1:n,op2:i,op3:s}=t,a=e[b].getValue(n),o=e[b].getValue(i),u=e.stack.pop(),l=(0,r.valueForRef)(u),c=s?e[b].getValue(s):null,d=e.elements().setDynamicAttribute(a,l,o,c);(0,r.isConstRef)(u)||e.updateWith(new We(u,d,e.env))}))
...
u.setup(i,A,w,P,!1)}i.push(u)}else i.push(u)})),ce.add(87,((e,t)=>{var{op1:r,op2:n}=t,i=e.fetchValue(n),{definition:s,manager:a,capabilities:u}=i
...
this.runtime=e,this.elementStack=n,this.context=i,this[At]=new Ht,this[jt]=new t.Stack,this.s0=null,this.s1=null,this.t0=null,this.t1=null,this.v0=null,this.resume=Wt(this.context)
...
case s.$t1:this.t1=t
break
case s.$v0:this.v0=t}}pushFrame(){this[h].pushFrame()}popFrame(){this[h].popFrame()}goto(e){this[h].goto(e)}call(e){this[h].call(e)}returnTo(e){this[h].returnTo(e)}return(){this[h].return()}static initial(e,t,r){var{handle:n,self:i,dynamicScope:s,treeBuilder:a,numSymbols:o,owner:u}=r,l=p.root(i,o,u),c=Gt(e.program.heap.getaddr(n),l,s),d=Wt(t)(e,c,a)
return d.pushUpdating(),d}static empty(e,t,n){var{handle:i,treeBuilder:s,dynamicScope:a,owner:o}=t,u=Wt(n)(e,Gt(e.program.heap.getaddr(i),p.root(r.UNDEFINED_REFERENCE,0,o),a),s)
...
e.combine=x
var R=y(),P=y(),C=y()
p(R),g(R),p(R),b(R,x([P,C])),p(R),g(P),p(R),g(C),p(R),b(R,C),p(R),g(C),p(R)
var A=new WeakMap
...
return 2===arguments.length?(t=arguments[0],i=arguments[1],e=null):([e,t,n]=g(...arguments),void 0===n?i=0:a(i=n.pop())||(r=!0===i,i=n.pop())),[e,t,n,i=parseInt(i,10),r]}var y=0,_=0,O=0,E=0,w=0,T=0,k=0,x=0,R=0,P=0,C=0,A=0,j=0,S=0,M=0,N=0,I=0,D=0,L=0,F=0,U=0
...
var E=new WeakMap
function w(e,t,r){return void 0===t&&(t={}),void 0===r&&(r=!1),e.map(((n,i)=>{var{name:s,params:a,paramNames:o,context:u,route:l}=n,c=n
...
var s=E.get(this),a=new R(this.router,this.name,this.paramNames,n,this.route,r)
...
return r}function R(e,t){return{then:(r,n)=>e.call(t,r,n)}}function P(e,t){var r=function(){for(var r=arguments.length,n=new Array(r+1),i=!1,s=0;s<r;++s){var a=arguments[s]
if(!i){if(null!==a&&"object"==typeof a)if(a.constructor===T)i=!0
else try{i=a.then}catch(c){var o=new T(l)
return m(o,c),o}else i=!1
i&&!0!==i&&(a=R(i,a))}n[s]=a}var u=new T(l)
...
for(var ge in s("instrument",!0),ve)ve.hasOwnProperty(ge)&&fe(ge,ve[ge])}var be={asap:K,cast:pe,Promise:T,EventTarget:n,all:j,allSettled:M,race:N,hash:D,hashSettled:F,rethrow:U,defer:B,denodeify:P,configure:s,on:fe,off:me,resolve:$,reject:V,map:q,async:he,filter:G}
...
return Object.keys(n).forEach((function(e){s[e]=n[e]})),s.enumerable=!!s.enumerable,s.configurable=!!s.configurable,("value"in s||s.initializer)&&(s.writable=!0),s=r.slice().reverse().reduce((function(r,n){return n(e,t,r)||r}),s),i&&void 0!==s.initializer&&(s.value=s.initializer?s.initializer.call(i):void 0,s.initializer=void 0),void 0===s.initializer&&(Object.defineProperty(e,t,s),s=null),s}Object.defineProperty(e,"__esModule",{value:!0}),e.AssetContainerResource=void 0,e.loadAssetContainer=function(e,t){return c.from(e,t)}
let c=(a=class extends t.Resource{constructor(e){var t,r,n,i
super(e),t=this,r="assets",i=this,(n=o)&&Object.defineProperty(t,r,{enumerable:n.enumerable,configurable:n.configurable,writable:n.writable,value:n.initializer?n.initializer.call(i):void 0}),u(this,"_assets",void 0),u(this,"promise",void 0),(0,s.registerDestructor)(this,(()=>this._assets?.dispose()))}modify(e,t){let{url:r,scene:n}=t
this._assets&&(this._assets.dispose(),this.assets=this._assets=void 0),r&&this.load(r,n)}async load(e,t){this.promise=this._load(e,t)
try{const e=await this.promise
this.assets=e,this._assets=e}catch(r){console.error(`Failed to load asset container from URL "${e}": ${r.message}`),this.assets=null}}async _load(e,t){return n.SceneLoader.LoadAssetContainerAsync(e,"",t)}},o=l(a.prototype,"assets",[i.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),l(a.prototype,"load",[r.waitFor],Object.getOwnPropertyDescriptor(a.prototype,"load"),a.prototype),a)
e.AssetContainerResource=c})),define("ember-load-initializers/index",["exports","require"],(function(e,t){"use strict"
